...
// Class: prRenderer_GL3
//      Renderer for OpenGL 3
class prRenderer_GL3 : public prRenderer
{
public:
    // Method: prRenderer_GL3
    //      Ctor
    prRenderer_GL3();
...
private:
    ...
    prRenderer_GL3(const prRenderer_GL3&);
    const prRenderer_GL3& operator = (const prRenderer_GL3&);
...
void TestCode(const u8* data);
void DrawTestCode(prShader&);
