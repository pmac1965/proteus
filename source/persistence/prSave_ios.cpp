...
/// Ctor
/// ---------------------------------------------------------------------------
prSaveIos::prSaveIos() : pImpl (new SaveIosImplementation())
                       , imp   (*pImpl)
{
    // Write startup info?
