...
/// Ctor
/// ---------------------------------------------------------------------------
prSaveMac::prSaveMac() : pImpl (new SaveMacImplementation())
                       , imp   (*pImpl)
{
    // Write startup info?
