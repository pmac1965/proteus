...
//      Sound system controller for android.
class prSoundManager_Android : public prSoundManager
{
public:
    // Method: prSoundManager_Android
    //      Ctor
    prSoundManager_Android();
